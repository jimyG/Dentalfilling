...
<head>
    ...
    <link href="{{ asset('tools/bootstrap/css/bootstrap.css') }}" rel="stylesheet">
<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->

<!-- Si necesitas agregar una imagen desde la carpeta public/img -->
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
...
<body>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 text-right">
                                    ...
                                    <img style="display:inline-block;" src="{{ url('img/extraccion.png') }}">
                                    <br> Indicada Para Extracción = <i style="color:red;" class="fa fa-times fa-2x"></i>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('tools/bootstrap/bootstrap.js') }}"></script>
